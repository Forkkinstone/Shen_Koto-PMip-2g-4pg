...
// 4.1
  ...
  //       if (f && (c%b == 0))
  //     {
  //         cout << (((a+b)/c) - (c/b)); // Вывод при успешном выполении первого условия
  //     }
  //     else if (f && (c%b != 0)) // Конструкция else if (Иначе если) применяется при наличинии дополнительного условия
  //     {
